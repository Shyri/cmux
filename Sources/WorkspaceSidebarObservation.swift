...
extension Workspace {
    ...
    func makeSidebarObservationPublisher() -> AnyPublisher<Void, Never> {
        ...
        let claudeChatFields = Publishers.CombineLatest($hasClaudeChatRunning, $hasClaudeChatNeedsInput)
        ...
        return Publishers.CombineLatest4(
            ...
            .combineLatest(directoryChangeRevision, claudeChatFields)
            .compactMap { [weak self] values, directoryChangeRevision, claudeChatFields -> SidebarObservationState? in
                ...
                return SidebarObservationState(
                    ...
                    hasClaudeChatRunning: claudeChatFields.0,
                    hasClaudeChatNeedsInput: claudeChatFields.1,
