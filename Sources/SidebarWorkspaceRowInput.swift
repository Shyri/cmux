...
struct SidebarWorkspaceRowInput {
    ...
    /// See `SidebarWorkspaceRowSnapshot.hasClaudeChatRunning`.
    let hasClaudeChatRunning: Bool
    /// See `SidebarWorkspaceRowSnapshot.hasClaudeChatNeedsInput`.
    ...
    func rowSnapshot(list: SidebarWorkspaceRowsSnapshot) -> SidebarWorkspaceRowSnapshot {
        ...
        return SidebarWorkspaceRowSnapshot(
            ...
            hasClaudeChatRunning: hasClaudeChatRunning,
            hasClaudeChatNeedsInput: hasClaudeChatNeedsInput,
